      ...
      <div className="flex flex-col md:flex-row h-screen bg-slate-100 dark:bg-slate-800 font-sans">
        ...
        <main className="flex-1 p-4 sm:p-8 overflow-y-auto pb-24 md:pb-8">
          <Routes>
            ...
            />
{/* Fix: Pass the onLogsChange prop to LogBookPage as it is required for editing and deleting logs. */}
             <Route path="/logbook" element={<LogBookPage logs={logsData} onLogsChange={handleLogsChange} weeklySummaries={weeklySummaries} subjects={mockSubjects} />} />
